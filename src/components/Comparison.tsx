        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          >
            <div className="flex items-center justify-center mb-8 pb-6 border-b border-zinc-800">
              <h3 className="text-xl md:text-2xl font-bold text-zinc-400 text-center uppercase tracking-widest">Serviços Online</h3>
            </div>
            
            <ul className="space-y-6">
              <li className="flex items-center gap-4">
                <X className="w-6 h-6 text-red-500 shrink-0" />
                <span className="text-zinc-300 font-medium">Mensalidade recorrente</span>
              </li>
              <li className="flex items-center gap-4">
                <X className="w-6 h-6 text-red-500 shrink-0" />
                <span className="text-zinc-300 font-medium">Dependência de servidor</span>
              </li>
              <li className="flex items-center gap-4">
                <X className="w-6 h-6 text-red-500 shrink-0" />
                <span className="text-zinc-300 font-medium">Limites de uso estritos</span>
              </li>
              <li className="flex items-center gap-4">
                <X className="w-6 h-6 text-red-500 shrink-0" />
                <span className="text-zinc-300 font-medium">Limites de mensagens (Tokens)</span>
              </li>
              <li className="flex items-center gap-4">
                <X className="w-6 h-6 text-red-500 shrink-0" />
                <span className="text-zinc-300 font-medium">Dependência total da internet</span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center justify-center mb-8 pb-6 border-b border-[#00f0ff]/30 relative">
              <h3 className="text-2xl md:text-3xl font-bold text-white text-center uppercase tracking-widest drop-shadow-md">IA OFFLINE</h3>
            </div>
            ...
            <ul className="space-y-6 relative">
              <li className="flex items-center gap-4">
                ...
                <span className="text-white font-bold text-lg">Pagamento único</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="bg-green-500/20 rounded-full p-1.5 shrink-0 shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                  <Check className="w-5 h-5 text-green-400" />
                </div>
                <span className="text-white font-bold text-lg">Uso ilimitado</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="bg-green-500/20 rounded-full p-1.5 shrink-0 shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                  <Check className="w-5 h-5 text-green-400" />
                </div>
                <span className="text-white font-bold text-lg">Privacidade total</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="bg-green-500/20 rounded-full p-1.5 shrink-0 shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                  <Check className="w-5 h-5 text-green-400" />
                </div>
                <span className="text-white font-bold text-lg">Sem limites de mensagens</span>
              </li>
              <li className="flex items-center gap-4">
                <div className="bg-green-500/20 rounded-full p-1.5 shrink-0 shadow-[0_0_15px_rgba(34,197,94,0.3)]">
                  <Check className="w-5 h-5 text-green-400" />
                </div>
                <span className="text-white font-bold text-lg">Sem necessidade de internet</span>
              </li>
            </ul>
