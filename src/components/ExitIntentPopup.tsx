            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="bg-zinc-800/50 border border-zinc-700/50 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 mt-2 w-full">
                <p className="text-base sm:text-lg text-zinc-300">
                  <span className="font-bold text-white text-lg sm:text-xl">Chame agora no WhatsApp</span>
                  <br />e comprando agora você ganha <br />
                  <span className="text-emerald-400 font-extrabold text-xl sm:text-2xl inline-block mt-2 drop-shadow-[0_0_10px_rgba(52,211,153,0.3)]">10% de DESCONTO</span>
                  <br /><span className="text-white font-bold inline-block mt-2 sm:mt-4">+ BÔNUS EXCLUSIVO!</span>
                  <br /><span className="text-[#00f0ff] font-extrabold text-[12px] sm:text-lg inline-block mt-1 bg-blue-900/40 px-2 sm:px-3 py-1 rounded-lg border border-blue-500/30">Pacote Para Usar iA Offline Sem Limites</span>
                </p>
              </div>
              ...
              <p className="text-zinc-500 text-xs sm:text-sm mt-4 cursor-pointer hover:text-zinc-400" onClick={() => setIsOpen(false)}>
