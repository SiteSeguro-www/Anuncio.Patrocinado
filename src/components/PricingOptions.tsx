    ...
    <section id="planos" className="py-24 bg-zinc-950 border-t border-zinc-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center max-w-xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10 flex-1">
              ...
              <p className="text-[#00f0ff] font-medium mb-6 text-lg">
                Receba os arquivos agora mesmo.
              </p>

              <div className="mb-8">
                <span className="text-blue-300/60 line-through text-lg font-medium">
                  De R$ 247,00
                </span>
                <div className="text-6xl font-bold text-white flex items-baseline gap-2 mt-1">
                  <span className="text-2xl text-[#00f0ff] font-medium">
                    Por
                  </span>{" "}
                  R$ 14<span className="text-2xl text-white/50">,90</span>
                </div>
              </div>

              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 text-white font-medium text-lg">
                  <Check className="w-6 h-6 text-[#00f0ff]" /> Entrega
                  instantânea
                </li>
                <li className="flex items-center gap-3 text-white font-medium text-lg">
                  <Check className="w-6 h-6 text-[#00f0ff]" /> Acesso imediato à
                  plataforma
                </li>
                <li className="flex items-center gap-3 text-white font-medium text-lg">
                  <Check className="w-6 h-6 text-[#00f0ff]" /> Atualizações
                  futuras grátis
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 text-center max-w-2xl mx-auto">
          <p className="text-zinc-400 text-lg">
            <strong>Atenção:</strong> Após realizar o pagamento, por favor envie
            uma mensagem no WhatsApp para{" "}
            <a
              href="https://wa.me/5511988677214"
              target="_blank"
              rel="noopener noreferrer"
            ...
            informando o comprovante para que possamos enviar seu link de acesso
            imediato.
          </p>
        </div>
      </div>
